    ...
    <div className='bg-white py-12'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          <h1 className='text-4xl font-bold text-[#ff5501]'>
            Proceso de Afiliación
          </h1>
          ...
          <div className='mt-8 grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <div className='text-blue-900 mb-4'>
                <FileText className='w-12 h-12 mx-auto text-[#228b22]' />
              </div>
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                1. Formulario
              </h3>
            ...
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <div className='text-blue-900 mb-4'>
                <Download className='w-12 h-12 mx-auto text-[#228b22]' />
              </div>
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                2. Documentos
              </h3>
            ...
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <div className='text-blue-900 mb-4'>
                <Mail className='w-12 h-12 mx-auto text-[#228b22]' />
              </div>
              <h3 className='text-xl font-semibold text-[#ff5501]'>3. Envío</h3>
              <p className='mt-2 text-gray-600'>
        ...
        <div className='mt-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              ...
              <p className='mt-2 text-gray-600'>
                Financia tus estudios o los de tu familia
              </p>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <PiggyBank className='w-12 h-12 text-[#228b22] mb-4' />
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                Crédito para Arreglos Locativos
              </h3>
              <p className='mt-2 text-gray-600'>
                Mejora tu vivienda con nuestro apoyo
              </p>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
            ...
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <Gift className='w-12 h-12 text-[#228b22] mb-4' />
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                Crédito para Turismo
              </h3>
              <p className='mt-2 text-gray-600'>
                Financia tus vacaciones soñadas
              </p>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg'>
              <Shield className='w-12 h-12 text-[#228b22] mb-4' />
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                Credi-Impuestos
              </h3>
              <p className='mt-2 text-gray-600'>
                Paga tus impuestos con facilidad
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='mt-16'>
          ...
          <div className='bg-white p-8 rounded-lg shadow-lg'>
            <p className='text-lg text-gray-700 mb-6'>
              En COONADOC nos preocupamos por tu bienestar y el de tu familia.
              Ofrecemos una amplia gama de seguros:
            </p>
            ...
            <ul className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-4'>
              <li className='flex items-center space-x-2'>
                <Gift className='w-5 h-5 text-[#228b22]' />
        ...
        <div className='mt-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white p-6 rounded-lg shadow-lg text-center'>
              <img
                src='https://images.pexels.com/photos/2888489/pexels-photo-2888489.jpeg'
                alt='Salitre Mágico'
            ...
            <div className='bg-white p-6 rounded-lg shadow-lg text-center'>
              ...
              <p className='mt-2 text-gray-600'>
                Precios preferenciales en boletas
              </p>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-lg text-center'>
              <img
        ...
        <div className='mt-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            >
              <FileText className='w-12 h-12 text-[#228b22] mb-4' />
              <h3 className='text-xl font-semibold text-[#ff5501]'>
                Solicitud de Crédito
              </h3>
              <p className='mt-2 text-gray-600'>
                Descarga el formulario de solicitud de crédito
              </p>
            </a>
            <a
              href='#'
            ...
            >
              ...
              <p className='mt-2 text-gray-600'>
                Formulario para solicitar auxilios
              </p>
            </a>
            <a
              href='#'
            ...
            >
              ...
              <p className='mt-2 text-gray-600'>
                Documentos adicionales para trámites
              </p>
            </a>
          </div>
        </div>
